...
- `config.json` 本地自动生成;字段:`api_key/base_url/model/temperature/max_tokens/system_prompt/auto_send/auto_region/region_stable/auto_answer/option_zones/geometry/update_repo/update_silent`;`config.example.json` 是模板,api_key 必须留空
